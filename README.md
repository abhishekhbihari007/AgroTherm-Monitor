# AgroTherm Monitor - Thermal Power Application

## Project Overview

This is a React-based thermal power application built with modern web technologies.
...
This creates a `dist` folder with the production build that you can deploy to any static hosting service.
